...
TabsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/home/eduardo/Documentos/Tesina/Test/farmaguia/src/pages/tabs/tabs.html"*/'<ion-tabs>\n  <ion-tab [root]="tab1Root" tabTitle="Home" tabIcon="home"></ion-tab>\n  <ion-tab [root]="tab2Root" tabTitle="Farmacias" tabIcon="medkit"></ion-tab>\n  <ion-tab [root]="tab3Root" tabTitle="Turnos" tabIcon="medical"></ion-tab>\n  <ion-tab [root]="tab4Root" tabTitle="FarmaCard" tabIcon="person"></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"/home/eduardo/Documentos/Tesina/Test/farmaguia/src/pages/tabs/tabs.html"*/
    }),
...
MapaPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["n" /* Component */])({
        selector: 'page-mapa',template:/*ion-inline-start:"/home/eduardo/Documentos/Tesina/Test/farmaguia/src/pages/mapa/mapa.html"*/'<ion-header>\n  <ion-navbar>\n      <ion-buttons right> \n          <button ion-button ion-only (click)="closeModal()">  \n            <ion-icon name="close"></ion-icon>\n          </button>\n        </ion-buttons>\n    <ion-title>mapa</ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content padding>\n  <div id="map"></div>\n</ion-content>\n'/*ion-inline-end:"/home/eduardo/Documentos/Tesina/Test/farmaguia/src/pages/mapa/mapa.html"*/,
    }),
...
ListaPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["n" /* Component */])({
        selector: 'page-lista',template:/*ion-inline-start:"/home/eduardo/Documentos/Tesina/Test/farmaguia/src/pages/lista/lista.html"*/'\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>Lista Farmacias</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n    <ion-list>\n      <ion-item   *ngFor="let farmacia of farmacias ; let index = index" (click)="detalles(farmacia)"  >\n        <ion-avatar class= "beat animateImage" item-start>\n          <img *ngIf="(abierto1[index] == 1)"  src="{{farmacia.image[0].imagen0}}">\n          <img *ngIf="!(abierto1[index] == 1)"  src="{{farmacia.image[2].imagen2}}">\n          <!--<img  src="{{farmacias.image[2].imagen2}}"> -->\n        </ion-avatar>\n        <div class="beat animateImage"  >\n          <h2><b>{{farmacia.nombre}}</b></h2>\n         <br>{{farmacia.direccion}}{{farmacia.image.imagen}}\n         <p *ngIf="isLV"> Horario LaV: {{farmacia.horario.lv[0].start1}} a {{farmacia.horario.lv[1].end1}} y {{farmacia.horario.lv[2].start2}} a {{farmacia.horario.lv[3].end2}}</p>\n         <p *ngIf="isS"> Horario Sabado: {{farmacia.horario.s[0].start1}} a {{farmacia.horario.s[1].end1}} y {{farmacia.horario.s[2].start2}} a {{farmacia.horario.s[3].end2}}</p>\n         <p *ngIf="isD"> Horario Domingo: {{farmacia.horario.d[0].start1}} a {{farmacia.horario.d[1].end1}} y {{farmacia.horario.d[2].start2}} a {{farmacia.horario.d[3].end2}}</p>\n          <!-- <p> {{isOpen}}{{today}}</p> -->\n         <h2 *ngIf="(abierto1[index] == 1)">Abierto</h2>\n         <h2 *ngIf="!(abierto1[index] == 1)" > Cerrado</h2>\n          <!--<p >{{abierto[index] }}</p> -->\n        </div>\n      </ion-item>\n    </ion-list>\n  \n</ion-content>\n'/*ion-inline-end:"/home/eduardo/Documentos/Tesina/Test/farmaguia/src/pages/lista/lista.html"*/,
    }),
...
ListaTurnosPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["n" /* Component */])({
        selector: 'page-lista-turnos',template:/*ion-inline-start:"/home/eduardo/Documentos/Tesina/Test/farmaguia/src/pages/lista-turnos/lista-turnos.html"*/'\n<ion-header>\n  \n    <ion-navbar>\n      <ion-title>Farmacias de Turno Hoy</ion-title>\n    </ion-navbar>\n  \n  </ion-header>\n  \n  \n  <ion-content padding>\n\n\n    <ion-card *ngFor="let turnos of turno2 let Tid = index"\n    (click)="detalles(turnos)">\n      <div class="farmacia">\n          <ion-row text-center>\n            <ion-col col-3>\n                <img  src="assets/img/cruzAzul.png">\n            </ion-col>\n            <ion-col>\n              <h1><b>{{turnos.nombre}}</b></h1>\n              <br>{{turnos.direccion}} <br> {{turnos.telefono}}\n              <h2 *ngIf="(Tid!==2)"><b>Abierto las 24 Horas</b> de 9:00  a 9:00</h2>\n              <h2 *ngIf="!(Tid!==2)"><b>Abierto hasta las 23:00 </b>de 9:00  a 23:00</h2>\n            </ion-col>\n          </ion-row>\n      </div>\n    </ion-card>\n     <!-- <ion-list>\n        <ion-item  *ngFor="let turnos of turno2 " >\n          <ion-avatar class= "beat animateImage" item-start>\n            <img  src="assets/img/cruzAzul.png">-->\n            \n            <!--<img  src="{{farmacias.image[2].imagen2}}"> -->\n         <!-- </ion-avatar>\n          <div class="beat animateImage"  >\n            <h2><b>{{turnos.nombre}}</b></h2>\n           <br>{{turnos.direccion}}  {{turnos.telefono}}\n           \n          </div>\n        </ion-item>\n      </ion-list>-->\n    \n  </ion-content>\n  '/*ion-inline-end:"/home/eduardo/Documentos/Tesina/Test/farmaguia/src/pages/lista-turnos/lista-turnos.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_3__providers_dataservice__["a" /* Dataservice */]])
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/home/eduardo/Documentos/Tesina/Test/farmaguia/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/home/eduardo/Documentos/Tesina/Test/farmaguia/src/app/app.html"*/
    }),
...
FarmaciaPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["n" /* Component */])({
        selector: 'page-farmacia',template:/*ion-inline-start:"/home/eduardo/Documentos/Tesina/Test/farmaguia/src/pages/farmacia/farmacia.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>farmacia</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content >\n  <ion-grid>\n      <ion-row>\n          <ion-col>\n            <agm-map \n              [latitude]="ubicacion.lat"\n              [longitude]="ubicacion.lng"\n              [zoom]="12"\n              [zoomControl]="true"\n              [streetViewControl]="true"\n              [disableDefaultUI]="true"> \n              <agm-marker \n              [latitude]="ubicacion.lat" \n              [longitude]="ubicacion.lng"\n              [iconUrl]="\'/assets/icon/marker-blue.png\'">\n            </agm-marker> \n              <agm-marker *ngFor="let marker of markers"\n                [latitude]="marker.lat" \n                [longitude]="marker.lng"\n                [iconUrl]="marker.icon">\n                <agm-info-window>{{marker.nombre}}<br>{{marker.direccion}}</agm-info-window>\n              </agm-marker> \n              \n              \n            </agm-map>\n          </ion-col>\n        </ion-row>\n  </ion-grid>\n\n</ion-content>\n'/*ion-inline-end:"/home/eduardo/Documentos/Tesina/Test/farmaguia/src/pages/farmacia/farmacia.html"*/,
    }),
...
FarmaciasDeTurnoPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["n" /* Component */])({
        selector: 'page-farmacias-de-turno',template:/*ion-inline-start:"/home/eduardo/Documentos/Tesina/Test/farmaguia/src/pages/farmacias-de-turno/farmacias-de-turno.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>farmaciasDeTurno</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content >\n  <ion-grid>\n      <ion-row>\n          <ion-col>\n            <agm-map \n              [latitude]="ubicacion.lat"\n              [longitude]="ubicacion.lng"\n              [zoom]="12"\n              [zoomControl]="true"\n              [streetViewControl]="true"\n              [disableDefaultUI]="true"> \n              <agm-marker \n              [latitude]="ubicacion.lat" \n              [longitude]="ubicacion.lng"\n              [iconUrl]="\'/assets/icon/marker-green.png\'">\n              <agm-info-window>¡¡¡Aca Toy!!!</agm-info-window>\n            </agm-marker> \n              <agm-marker *ngFor="let marker of markers; let i = index"\n              \n              [latitude]="marker.lat" \n                [longitude]="marker.lng"\n                [iconUrl]="\'/assets/icon/marker-blue.png\'"\n                [openInfoWindow]="true"> \n                \n                <agm-info-window>{{marker.nombre}}<br>{{marker.direccion}}</agm-info-window>\n              </agm-marker> \n              \n            </agm-map>\n          </ion-col>\n        </ion-row>\n  </ion-grid>\n\n</ion-content>'/*ion-inline-end:"/home/eduardo/Documentos/Tesina/Test/farmaguia/src/pages/farmacias-de-turno/farmacias-de-turno.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0_ionic_angular__["e" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_0_ionic_angular__["f" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_3__providers_dataservice__["a" /* Dataservice */],
...
FarmaciasAbiertasPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["n" /* Component */])({
        selector: 'page-farmacias-abiertas',template:/*ion-inline-start:"/home/eduardo/Documentos/Tesina/Test/farmaguia/src/pages/farmacias-abiertas/farmacias-abiertas.html"*/'\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>farmaciasAbiertas</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content >\n  <ion-grid>\n      <ion-row>\n          <ion-col>\n            <agm-map \n              [latitude]="ubicacion.lat"\n              [longitude]="ubicacion.lng"\n              [zoom]="12"\n              [zoomControl]="true"\n              [streetViewControl]="true"\n              [disableDefaultUI]="true"> \n              <agm-marker \n              [latitude]="ubicacion.lat" \n              [longitude]="ubicacion.lng"\n              [iconUrl]="\'/assets/icon/marker-blue.png\'">\n              \n              \n              <agm-info-window>¡¡¡Aca Toy!!!</agm-info-window>\n            </agm-marker> \n              <agm-marker *ngFor="let marker of farmacias; let i = index"\n              \n                [latitude]="marker.lat" \n                [longitude]="marker.lng"\n                \n                [iconUrl]="\'/assets/icon/marker-green.png\'"\n                \n                [openInfoWindow]="true"> \n                \n                <agm-info-window>{{marker.nombre}}<br>{{marker.direccion}}<br>{{abierto1[i]}}</agm-info-window>\n              </agm-marker> \n              \n            </agm-map>\n          </ion-col>\n        </ion-row>\n  </ion-grid>\n\n</ion-content>\n'/*ion-inline-end:"/home/eduardo/Documentos/Tesina/Test/farmaguia/src/pages/farmacias-abiertas/farmacias-abiertas.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["e" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["f" /* NavParams */],
...
MapaTurnosPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_4__angular_core__["n" /* Component */])({
        selector: 'page-mapa-turnos',template:/*ion-inline-start:"/home/eduardo/Documentos/Tesina/Test/farmaguia/src/pages/mapa-turnos/mapa-turnos.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>mapaTurnos</ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content padding>\n    <div id="map"></div>\n</ion-content>\n\n'/*ion-inline-end:"/home/eduardo/Documentos/Tesina/Test/farmaguia/src/pages/mapa-turnos/mapa-turnos.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0_ionic_angular__["e" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_0_ionic_angular__["f" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_0_ionic_angular__["h" /* ToastController */],
...
MapaAbiertosPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["n" /* Component */])({
        selector: 'page-mapa-abiertos',template:/*ion-inline-start:"/home/eduardo/Documentos/Tesina/Test/farmaguia/src/pages/mapa-abiertos/mapa-abiertos.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>mapaAbiertos</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n    <div id="map"></div>\n</ion-content>\n'/*ion-inline-end:"/home/eduardo/Documentos/Tesina/Test/farmaguia/src/pages/mapa-abiertos/mapa-abiertos.html"*/,
    }),
...
DetallesPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["n" /* Component */])({
        selector: 'page-detalles',template:/*ion-inline-start:"/home/eduardo/Documentos/Tesina/Test/farmaguia/src/pages/detalles/detalles.html"*/'<!--\n  Generated template for the Detalles page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>detalles</ion-title>\n  </ion-navbar>\n    <div id="detalle" class="animateText">\n      <h2><b>{{markers.nombre}}</b></h2>\n      <p>Teléfono: {{markers.telefono}}</p>\n      <p> Dirección: {{markers.direccion}}</p>\n      <p>Horarios</p>\n      <p>Lunes a Viernes</p>\n      <p >  {{markers.horario.lv[0].start1}} a {{markers.horario.lv[1].end1}} y {{markers.horario.lv[2].start2}} a {{markers.horario.lv[3].end2}}</p>\n      <p>Sabados</p>\n      <p > Horario Sabado: {{markers.horario.s[0].start1}} a {{markers.horario.s[1].end1}} y {{markers.horario.s[2].start2}} a {{markers.horario.s[3].end2}}</p>\n      <p>Domingos</p>\n      <p *ngIf="(!markers.horario.d[0].start1 == \'\')"> Horario Domingo: {{markers.horario.d[0].start1}} a {{markers.horario.d[1].end1}} y {{markers.horario.d[2].start2}} a {{markers.horario.d[3].end2}}</p>\n      <p *ngIf="(markers.horario.d[0].start1 == \'\')">Cerrado</p>   \n      \n    </div>\n</ion-header>\n\n<ion-content>\n    <div id="mapa" ></div>\n<!--\n    <ion-grid>\n        <ion-row>\n            <ion-col>\n              <agm-map \n              [latitude]="markers.lat" \n              [longitude]="markers.lng"\n                [zoom]="17"\n                [zoomControl]="true"\n                [streetViewControl]="true"\n                [disableDefaultUI]="true"> \n                <agm-marker \n                [latitude]="myPosition.latitude"\n                [longitude]="myPosition.longitude"\n                [iconUrl]="\'/assets/icon/marker-blue.png\'">\n              </agm-marker> \n                <agm-marker\n                  [latitude]="markers.lat" \n                  [longitude]="markers.lng"\n                  [iconUrl]="markers.icon">\n                  <agm-info-window>{{markers.nombre}}<br>{{markers.direccion}}</agm-info-window>\n                </agm-marker> \n                \n                \n              </agm-map>\n            </ion-col>\n          </ion-row>\n    </ion-grid>-->\n</ion-content>\n'/*ion-inline-end:"/home/eduardo/Documentos/Tesina/Test/farmaguia/src/pages/detalles/detalles.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0_ionic_angular__["f" /* NavParams */],
        __WEBPACK_IMPORTED_MODULE_0_ionic_angular__["h" /* ToastController */],
